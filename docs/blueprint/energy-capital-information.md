...
```mermaid
graph TB
    E["<b>ENERGY CONTROL</b><br/>Physical Execution Capacity<br/><i>Power grids, compute,<br/>robotics, actuation</i>"]
    C["<b>CAPITAL ALLOCATION</b><br/>Direction of Growth<br/><i>AI treasury, venture allocation,<br/>resource pricing</i>"]
    I["<b>INFORMATION DISTRIBUTION</b><br/>Direction of Thought<br/><i>Model routing, memory,<br/>marketplace, governance</i>"]

    E -->|"energy enables<br/>capital generation"| C
    C -->|"capital funds<br/>information systems"| I
    I -->|"information optimizes<br/>energy usage"| E

    E -->|"energy constrains<br/>information processing"| I
    I -->|"information directs<br/>capital allocation"| C
    C -->|"capital procures<br/>energy infrastructure"| E
```
...
```mermaid
flowchart TB
    subgraph EnergyStack["Energy Control Stack"]
        direction TB
        GEN["Generation<br/><i>Solar, wind, nuclear,<br/>grid contracts</i>"]
        DIST["Distribution<br/><i>Grid management,<br/>edge computing</i>"]
        COMPUTE["Compute Allocation<br/><i>Workload scheduling,<br/>model routing</i>"]
        ACTUATION["Physical Actuation<br/><i>Robotics, manufacturing,<br/>logistics</i>"]

        GEN --> DIST --> COMPUTE --> ACTUATION
    end

    subgraph Optimization["Optimization Layer"]
        OPT["Energy-Aware<br/>Optimization"]
        CARBON["Carbon<br/>Accounting"]
        THERMAL["Thermal<br/>Recycling"]
    end
...
```mermaid
flowchart TB
    subgraph CapitalStack["Capital Allocation Stack"]
        direction TB
        TREASURY["AI Treasury<br/><i>Cash management,<br/>yield optimization</i>"]
        VENTURE["Venture Allocation<br/><i>New entity funding,<br/>growth investment</i>"]
        RESOURCE["Resource Pricing<br/><i>Internal transfer pricing,<br/>marketplace economics</i>"]
        BUDGET["Budget Enforcement<br/><i>Agent-level spend controls,<br/>ROI tracking</i>"]

        TREASURY --> VENTURE --> RESOURCE --> BUDGET
    end

    subgraph Signals["Allocation Signals"]
        PERF["Performance Data<br/><i>Revenue, efficiency,<br/>quality metrics</i>"]
        MARKET["Market Signals<br/><i>Demand, competition,<br/>opportunity</i>"]
        STRAT["Strategic Priority<br/><i>Blueprint alignment,<br/>monopoly layer focus</i>"]
    end
...
```mermaid
flowchart TB
    subgraph InfoStack["Information Distribution Stack"]
        direction TB
        ROUTING["Model Routing<br/><i>Which intelligence<br/>answers which questions</i>"]
        MEMORY["Memory Management<br/><i>What is remembered<br/>and retrieved</i>"]
        MARKET_SIG["Marketplace Signals<br/><i>Visibility, pricing,<br/>recommendation</i>"]
        GOV_RULES["Governance Rules<br/><i>What is permitted,<br/>rewarded, prohibited</i>"]
        NARRATIVE["Narrative Layer<br/><i>Thought leadership,<br/>authority, framing</i>"]

        ROUTING --> MEMORY --> MARKET_SIG --> GOV_RULES --> NARRATIVE
    end
```
...
graph LR
    ...
    E -->|"1. Energy generates<br/>capital through production"| C
    C -->|"2. Capital procures<br/>energy infrastructure"| E

    C -->|"3. Capital funds<br/>information systems"| I
    I -->|"4. Information directs<br/>capital allocation"| C

    I -->|"5. Information optimizes<br/>energy consumption"| E
    E -->|"6. Energy constrains<br/>information processing"| I
```
...
```mermaid
graph TB
    subgraph Stable["Stable Triad — Virtuous Cycle"]
        E1["Energy<br/>Growing capacity"]
        C1["Capital<br/>Growing reserves"]
        I1["Information<br/>Growing precision"]
...
```mermaid
graph TB
    subgraph Unstable["Unstable Triad — Degradation Spiral"]
        E2["Energy<br/>Shrinking capacity"]
        C2["Capital<br/>Shrinking reserves"]
        I2["Information<br/>Declining quality"]
