...
flowchart TD
    A["Individual Belief
    (private conviction)"] --> B["Shared Belief
    (community consensus)"]
    B --> C["Codified Belief
    (doctrine, manifesto, scripture)"]
    C --> D["Institutional Belief
    (organizational charter, law)"]
    D --> E["Structural Belief
    (embedded in systems, architecture, defaults)"]
    E --> F["Invisible Belief
    (nobody remembers it is a belief)"]

    F -.->|"Appears as 'reality'"| G["Institutional Inertia
    (resistance to change)"]

    style A fill:#1a3a4a,stroke:#4a9aba,color:#fff
    style B fill:#1a3a3a,stroke:#4ababa,color:#fff
    style C fill:#2a3a1a,stroke:#6aba4a,color:#fff
    style D fill:#3a3a1a,stroke:#baba4a,color:#fff
    style E fill:#3a2a1a,stroke:#ba8a4a,color:#fff
    style F fill:#3a1a1a,stroke:#ba4a4a,color:#fff
    style G fill:#4a1a1a,stroke:#ba2a2a,color:#fff
```
