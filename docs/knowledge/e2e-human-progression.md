...
```mermaid
graph LR
    subgraph P1["Phase I: Pre-Outcome
    Formation Under Noise"]
        direction TB
        S1["1. Ignorance"]
        S2["2. Disruption"]
        S3["3. False Awareness"]
        S4["4. Awareness"]
        S5["5. Intent"]
        S6["6. Learning"]
        S1 --> S2 --> S3 --> S4 --> S5 --> S6
    ...
    subgraph P2["Phase II: Outcome Production"]
        direction TB
        S7["7. Pattern Recognition"]
        S8["8. Execution Under Constraint"]
        S9["9. Controlled Outcome"]
        S10["10. Compound Results"]
        S7 --> S8 --> S9 --> S10
    end

    subgraph P3["Phase III: Post-Outcome
    Power Under Constraint"]
        direction TB
        S11["11. Authority Without Enforcement"]
        S12["12. Structural Influence"]
        S13["13. Systems Design"]
        S14["14. Legacy Architecture"]
        S11 --> S12 --> S13 --> S14
    end

    subgraph P4["Phase IV: Beyond Outcomes"]
        direction TB
        S15["15. Constraint Design"]
        S16["16. Institutional Permanence"]
        S15 --> S16
    end

    P1 --> P2 --> P3 --> P4

    style P1 fill:#1a1a3a,stroke:#6a6aba,color:#fff
    style P2 fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style P3 fill:#3a3a1a,stroke:#baba6a,color:#fff
    style P4 fill:#3a1a1a,stroke:#ba6a6a,color:#fff
```
