...
```mermaid
timeline
    title Protocols That Became Infrastructure
    1494 : Double-Entry Bookkeeping
         : Enabled trust between strangers
         : Still governs all accounting
    1694 : Central Banking
         : Enabled monetary coordination
         : Still governs all currencies
    1773 : Clearing Houses
         : Enabled inter-bank settlement
         : Still governs all financial transactions
    1969 : Internet Routing (TCP/IP)
         : Enabled digital coordination
         : Still governs all internet traffic
    2025+ : Obligation Infrastructure (AINEFF)
          : Enabling governance coordination
          : Designed to govern all obligation flows
```
...
```mermaid
flowchart TB
    subgraph FRAG["The Four Fragmentations"]
        T["Trust
    ...
    O --> V["Value Capture:
    Tax on every obligation
    that flows through
    the protocol"]

    style FRAG fill:#1a1a2a,stroke:#4a4a6a,color:#fff
    style T fill:#2a1a1a,stroke:#6a4a4a,color:#fff
    style I fill:#2a1a1a,stroke:#6a4a4a,color:#fff
    style G fill:#2a1a1a,stroke:#6a4a4a,color:#fff
    style C fill:#2a1a1a,stroke:#6a4a4a,color:#fff
    style O fill:#1a2a1a,stroke:#4a6a4a,color:#fff
    style V fill:#1a3a1a,stroke:#4a8a4a,color:#fff
```
...
```mermaid
graph LR
    subgraph MULTIPLES["Valuation Multiple by Position"]
        C["Consulting
        1–3x Revenue"]
        S["SaaS Platform
        5–10x Revenue"]
    ...
    style C fill:#3a1a1a,stroke:#8a4a4a,color:#fff
    style S fill:#3a2a1a,stroke:#8a6a4a,color:#fff
    style G fill:#2a3a1a,stroke:#6a8a4a,color:#fff
    style O fill:#1a3a1a,stroke:#4a8a4a,color:#fff
```
...
flowchart LR
    M["Methodology
    'Here is how we
    think about this'"] --> F["Framework
    'Here is a structured
    approach anyone can use'"]
    F --> S["Standard
    'Here is what industry
    has adopted as baseline'"]
    S --> R["Regulation
    'Here is what the law
    now requires'"]
    R --> INF["= Infinite Leverage"]

    style M fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style F fill:#1a3a3a,stroke:#4a8a8a,color:#fff
    style S fill:#1a3a1a,stroke:#4a8a4a,color:#fff
    style R fill:#2a3a1a,stroke:#6a8a4a,color:#fff
