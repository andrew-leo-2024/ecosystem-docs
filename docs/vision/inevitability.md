...
flowchart TB
    I["Global
    Inevitability"] --> SN["Structural Necessity
    The problem it solves
    cannot remain unsolved"]
    I --> SC["Singularity of Capability
    No alternative can solve
    it as completely"]
    I --> TC["Temporal Compression
    The window for alternatives
    is closing"]
    I --> AR["Adversarial Robustness
    It works even when
    participants resist it"]

    SN --> SNT["Test: Does the problem
    get worse if ignored?"]
    SC --> SCT["Test: Can a competitor
    replicate the full stack?"]
    TC --> TCT["Test: Is the adoption
    window narrowing?"]
    AR --> ART["Test: Does it function
    under hostile conditions?"]

    style I fill:#3a3a1a,stroke:#baba4a,color:#fff
    style SN fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style SC fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style TC fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style AR fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style SNT fill:#1a1a2a,stroke:#4a4a6a,color:#ccc
    style SCT fill:#1a1a2a,stroke:#4a4a6a,color:#ccc
    style TCT fill:#1a1a2a,stroke:#4a4a6a,color:#ccc
    style ART fill:#1a1a2a,stroke:#4a4a6a,color:#ccc
```
...
```mermaid
graph LR
    subgraph WINDOW["Temporal Compression"]
        direction TB
        Y1["Year 1:
    ...
    style WINDOW fill:#1a1a2a,stroke:#4a4a6a,color:#fff
    style Y1 fill:#1a3a1a,stroke:#4a8a4a,color:#fff
    style Y3 fill:#2a3a1a,stroke:#6a8a4a,color:#fff
    style Y5 fill:#3a3a1a,stroke:#8a8a4a,color:#fff
    style Y7 fill:#3a2a1a,stroke:#8a6a4a,color:#fff
    style Y10 fill:#3a1a1a,stroke:#8a4a4a,color:#fff
```
...
flowchart LR
    ...
    TR --> LE["Legitimacy
    (next)"]
    LE --> RE["Responsibility
    (terminal)"]

    style M fill:#1a1a2a,stroke:#4a4a6a,color:#ccc
    style CO fill:#1a1a2a,stroke:#4a4a8a,color:#ccc
    style IN fill:#1a2a3a,stroke:#4a6a8a,color:#fff
    style AT fill:#2a2a3a,stroke:#6a6a8a,color:#fff
    style TR fill:#2a3a3a,stroke:#6a8a8a,color:#fff
    style LE fill:#3a3a2a,stroke:#8a8a6a,color:#fff
    style RE fill:#3a3a1a,stroke:#baba4a,color:#fff
```
