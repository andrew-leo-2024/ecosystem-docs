...
flowchart LR
    ...
    Cost: $12
    Revenue: $0
    Conversations: 0"] --> W2["Week 2: CONVERSATIONS
    Cost: $0
    Revenue: $0
    Conversations: 6"]
    W2 --> W3["Week 3: FIRST MONEY
    Cost: $0
    Revenue: $5-15K
    Conversations: 10"]
    W3 --> W4["Week 4: COMPOUND
    Cost: $0
    Revenue: $10-30K
    Conversations: 15+"]

    style W1 fill:#2a1a1a,stroke:#ba6a4a,color:#fff
    style W2 fill:#1a2a1a,stroke:#4aba6a,color:#fff
    style W3 fill:#1a1a2a,stroke:#4a6aba,color:#fff
    style W4 fill:#2a2a1a,stroke:#baba4a,color:#fff
```
