...
```mermaid
flowchart TD
    subgraph ASSETS["Seven Compounding Asset Classes"]
        direction TB
    ...
    style ASSETS fill:#1a1a2e,stroke:#4a9aba,color:#fff
```
...
```mermaid
graph LR
    subgraph CLIENTS["Client Growth"]
        C1["Month 3: 3 clients
        Founder-sold, founder-delivered"] --> C6["Month 6: 12 clients
        Founder-sold, operator-assisted"]
        C6 --> C12["Month 12: 40 clients
        Mixed acquisition channels"]
        C12 --> C24["Month 24: 200 clients
        Referral + inbound dominant"]
        C24 --> C36["Month 36: 650+ clients
        Self-sustaining growth"]
    end

    style C1 fill:#1a3a1a,stroke:#4aba4a,color:#fff
    style C36 fill:#1a1a3a,stroke:#4a4aba,color:#fff
```
...
```mermaid
gantt
    title Infrastructure Activation Timeline
    dateFormat YYYY-MM
    axisFormat %b %Y

    section Revenue Capital
    Active from Day 1              :a1, 2026-03, 36M

    section Client Relationships
    Founder-direct                 :a2a, 2026-03, 6M
    Referral engine                :a2b, 2026-09, 12M
    Self-sustaining                :a2c, 2027-09, 18M

    section Operational Data
    Manual collection              :a3a, 2026-03, 6M
    Automated collection           :a3b, 2026-09, 12M
    Pattern library                :a3c, 2027-09, 18M

    section Operator Network
    First operator                 :a4a, 2026-06, 6M
    Scaled network                 :a4b, 2026-12, 12M
    Self-replicating               :a4c, 2027-12, 12M

    section Product Infrastructure
    MVP                            :a5a, 2026-03, 6M
    v1.0-2.0                       :a5b, 2026-09, 12M
    Platform                       :a5c, 2027-09, 18M

    section Regulatory Credibility
    First contacts                 :a6a, 2026-09, 6M
    Framework published            :a6b, 2027-03, 12M
    Standards referenced           :a6c, 2028-03, 12M

    section Protocol Position
    Design phase                   :a7a, 2027-03, 6M
    ORF prototype (Month 18+)     :a7b, 2027-09, 6M
    Protocol adoption              :a7c, 2028-03, 12M
    Infrastructure status          :a7d, 2029-03, 12M
```
...
flowchart TD
    REV["Revenue
    Funds everything"] --> CLIENTS["More Clients
    More relationships"]
    CLIENTS --> DATA["More Data
    Better patterns"]
    DATA --> PRODUCT["Better Product
    More features, less friction"]
    PRODUCT --> CLIENTS
    CLIENTS --> OPERATORS["More Operators
    More delivery capacity"]
    OPERATORS --> REV
    DATA --> REGULATORY["Regulatory Credibility
    Governance authority"]
    REGULATORY --> CLIENTS
    REGULATORY --> PROTOCOL["Protocol Position
    Structural irreversibility"]
    PROTOCOL --> REV

    style REV fill:#2a1a1a,stroke:#ba4a4a,color:#fff
    style CLIENTS fill:#1a3a1a,stroke:#4aba4a,color:#fff
    style DATA fill:#1a1a3a,stroke:#4a4aba,color:#fff
    style PRODUCT fill:#2a2a1a,stroke:#baba4a,color:#fff
    style OPERATORS fill:#1a2a2a,stroke:#4ababa,color:#fff
    style REGULATORY fill:#2a1a2a,stroke:#ba4aba,color:#fff
    style PROTOCOL fill:#3a1a1a,stroke:#ba6a4a,color:#fff
```
