...
graph LR
    ...
    Ask questions. No action."]
    S3["Stage 3
    ASSIST
    Support experienced operators.
    Bounded contribution."]
    S4["Stage 4
    EXECUTE
    (Bounded)
    Independent work within
    hard constraints."]
    S5["Stage 5
    EXECUTE
    (Autonomous)
    ...
    ALLOCATE CAPITAL
    Lead others. Deploy
    resources. Accept liability."]

    S1 --> S2 --> S3 --> S4 --> S5 --> S6

    style S1 fill:#3a1a1a,stroke:#ba6a6a,color:#fff
    style S2 fill:#3a2a1a,stroke:#ba8a4a,color:#fff
    style S3 fill:#2a2a1a,stroke:#baba4a,color:#fff
    style S4 fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style S5 fill:#1a2a3a,stroke:#4a8aba,color:#fff
    style S6 fill:#1a1a3a,stroke:#6a6aba,color:#fff
```
...
```mermaid
graph TB
    subgraph L1["Layer 1: Foundation (Intake)"]
        F["Filtering, aptitude assessment,
        constitutional framework introduction,
        cultural alignment"]
    end

    subgraph L2["Layer 2: Intelligence (Capability Building)"]
        I["Technical training, governance literacy,
        AI systems understanding,
        operational pattern recognition"]
    end

    subgraph L3["Layer 3: Production (Live Deployment)"]
        P["Real venture cell participation,
        supervised execution,
        governance artifact production"]
    end

    subgraph L4["Layer 4: Capital (Venture Integration)"]
        C["Capital allocation understanding,
        revenue validation skills,
        business model literacy"]
    end

    subgraph L5["Layer 5: Resilience (Stress Testing)"]
        R["Simulated failure scenarios,
    ...
    style L1 fill:#3a1a1a,stroke:#ba6a6a,color:#fff
    style L2 fill:#3a2a1a,stroke:#ba8a4a,color:#fff
    style L3 fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style L4 fill:#2a2a1a,stroke:#baba4a,color:#fff
    style L5 fill:#1a1a3a,stroke:#6a6aba,color:#fff
```
