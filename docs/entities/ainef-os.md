...
graph TB
    subgraph L1["Layer 1: Foundation"]
        ...
        from AINEFF, legal infrastructure,
        entity templates, canonical ontology"]
    end

    subgraph L2["Layer 2: Intelligence"]
        I["Data architecture, memory systems,
        AI agent infrastructure,
        knowledge management"]
    end

    subgraph L3["Layer 3: Production"]
        P["Venture cell spawning,
        product development pipelines,
        deployment infrastructure"]
    end

    subgraph L4["Layer 4: Capital"]
        C["Capital allocation engines,
        revenue validation,
        financial controls, envelope management"]
    end

    subgraph L5["Layer 5: Talent"]
        T["Operator intake, certification,
        deployment, performance tracking,
        skill taxonomy"]
    end

    subgraph L6["Layer 6: Learning"]
        Le["Post-mortem systems,
        pattern recognition,
        institutional memory,
        failure libraries"]
    end

    subgraph L7["Layer 7: Resilience"]
        R["Stress testing, failure simulation,
        contagion firewalls,
        recovery protocols"]
    end
    ...
    style L2 fill:#1a2a3a,stroke:#4a8aba,color:#fff
    style L3 fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style L4 fill:#2a3a1a,stroke:#8aba4a,color:#fff
    style L5 fill:#3a3a1a,stroke:#baba4a,color:#fff
    style L6 fill:#3a2a1a,stroke:#ba8a4a,color:#fff
    style L7 fill:#3a1a1a,stroke:#ba6a6a,color:#fff
```
...
graph TB
    ...
    style Cell fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style Team fill:#1a2a3a,stroke:#4a8aba,color:#fff
    style Outputs fill:#2a2a1a,stroke:#baba4a,color:#fff
```
...
```mermaid
graph LR
    subgraph Pillar1["AINEF OS"]
        P1["Venture Production
        Spawns, funds, governs
        venture cells"]
    end

    subgraph Pillar2["Frankmax"]
        P2["Governance Substrate
        Pre-incident accountability,
        audit, legal evidence"]
    end

    subgraph Pillar3["LevelUpMax"]
        P3["Talent Refinery
        Operator intake,
        certification, deployment"]
    end

    P1 -->|"Requires governance from"| P2
    P1 -->|"Requires operators from"| P3
    P2 -->|"Governs production in"| P1
    P2 -->|"Certifies talent in"| P3
    P3 -->|"Supplies operators to"| P1
    P3 -->|"Produces evidence for"| P2

    style Pillar1 fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style Pillar2 fill:#3a1a3a,stroke:#ba6aba,color:#fff
    style Pillar3 fill:#1a3a3a,stroke:#4ababa,color:#fff
```
