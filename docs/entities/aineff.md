...
graph LR
    ...
    MB["Mandate Boundaries
    What each entity is
    allowed to do"]

    AC["Authority Ceilings
    Maximum power any
    entity can accumulate"]

    FT["Failure Thresholds
    When an entity must
    be investigated or killed"]
    ...
    style MB fill:#1a3a1a,stroke:#6aba6a,color:#fff
    style AC fill:#2a2a1a,stroke:#baba4a,color:#fff
    style FT fill:#3a1a1a,stroke:#ba6a6a,color:#fff
    style ER fill:#1a3a3a,stroke:#4ababa,color:#fff
    style DC fill:#3a1a3a,stroke:#ba6aba,color:#fff
```
