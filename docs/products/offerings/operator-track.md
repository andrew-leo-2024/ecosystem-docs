...
```mermaid
flowchart LR
    A["Track 1<br/>Foundation"] --> B["Track 2<br/>Diagnostic"]
    B --> C["Junior Diagnostic<br/>$65K-$80K"]
    C --> D["Senior Diagnostic<br/>$85K-$110K"]
    D --> E["Diagnostic Lead<br/>$110K-$135K"]
```
...
```mermaid
flowchart LR
    A["Track 1-2"] --> B["Track 3<br/>Governance"]
    B --> C["Governance Analyst<br/>$75K-$95K"]
    C --> D["Governance Consultant<br/>$95K-$125K"]
    D --> E["Governance Director<br/>$130K-$165K"]
```
...
```mermaid
flowchart LR
    A["Track 1-3"] --> B["Track 4<br/>Cell Lead"]
    B --> C["Cell Operator<br/>$80K-$100K"]
    C --> D["Cell Lead<br/>$100K-$130K"]
    D --> E["Regional Lead<br/>$130K-$170K"]
```
...
```mermaid
flowchart LR
    A["Track 1-4"] --> B["Track 5<br/>Master"]
    B --> C["Master Operator<br/>$120K-$150K"]
    C --> D["Practice Lead<br/>$150K-$200K"]
    D --> E["VP Operations<br/>$180K-$250K+"]
```
...
```mermaid
flowchart TD
    A["Discovery<br/>Governance Gap Analyzer"] --> B["Track 1<br/>Foundation ($500)"]
    B --> C["Track 2<br/>Diagnostic ($750)"]
    C --> D{"Career Path<br/>Selection"}
    D --> E["Track 3<br/>Governance ($1,000)"]
    D --> F["Diagnostic Career<br/>$65K-$135K"]
    E --> G["Track 4<br/>Cell Lead ($1,250)"]
    E --> H["Governance Career<br/>$75K-$165K"]
    G --> I["Track 5<br/>Master ($1,500)"]
    G --> J["Cell Lead Career<br/>$80K-$170K"]
    I --> K["Master Operator Career<br/>$120K-$250K+"]
    K --> L["Franchise Owner<br/>Revenue share"]
```
