...
```mermaid
flowchart TD
    A["100 Free Diagnostics"] --> B["40-50 Paid Wedges<br/>$8K-$15K each"]
    B --> C{"90-Day Result"}
    C -->|"20-30%"| D["Terminate<br/>$12K CLV"]
    C -->|"30-40%"| E["Retainer<br/>$2K-$5K/mo"]
    C -->|"20-25%"| F["Second Wedge<br/>$12K-$15K"]
    C -->|"10-15%"| G["Training License<br/>$500-$1.5K/person"]
    C -->|"5-10%"| H["Enterprise Deploy<br/>$100K-$500K"]

    E --> I["Governance Engagement<br/>$8K-$20K"]
    F --> E
    I --> J["PIAR<br/>$25K-$75K"]
    J --> H
    H --> K["ORF Protocol<br/>$500K"]
```
