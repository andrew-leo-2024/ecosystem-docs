...
```mermaid
gantt
    title Market Wedge Activation Timeline
    dateFormat YYYY-MM
    axisFormat %b %Y
    section Phase 0
        Professional Services     :ps, 2026-03, 3M
        Healthcare (Claims)       :hc, 2026-03, 4M
    section Phase 1
        Manufacturing             :mfg, 2026-06, 4M
        Logistics                 :log, 2026-07, 5M
    section Phase 2
        Banking                   :bnk, 2026-10, 6M
        Construction              :con, 2026-11, 6M
```
