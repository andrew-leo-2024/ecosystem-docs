...
```mermaid
graph LR
    A["Claims Automation Sprint<br/>$7.5K-$12K"] --> B["Compliance Documentation<br/>DocuFlow $49/mo"]
    B --> C["Chokepoint Diagnostic<br/>$5K-$15K"]
    C --> D["PIAR for Claims Decisions<br/>$25K-$75K"]
    D --> E["Governance License<br/>$200K"]
    E --> F["ORF Protocol<br/>$500K"]

    A --> G["Data Gravity<br/>Claims patterns, risk signals"]
    G --> H["Pricing Intelligence<br/>Data products"]
    G --> I["Risk Models<br/>Underwriting insights"]
    G --> J["Compliance Telemetry<br/>Regulatory reporting"]
```
