...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v1_launch',
      content: '<strong>AINEFF Ecosystem v1.2</strong> — 164 pages of constitutional infrastructure documentation + sovereign deployment architecture.',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Sovereign Architecture', to: '/docs/sovereign/' },
          ],
        },
      ],
